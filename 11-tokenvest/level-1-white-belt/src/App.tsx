...
const project = {
  ...
  "title": "TokenVest",
  "short": "TokenVest",
  "useCase": "tokenized savings baskets",
  "audience": "portfolio builders",
  "primary": "#214e34",
  "secondary": "#7bd389",
  "accent": "#d8a31a",
  "paper": "#f3f7ec",
  "ink": "#18251b",
  "surface": "#ffffff",
  "layout": "layout-market",
  "nav": "quotes",
  "contract": "token vesting desk",
  "action": "Commit allocation",
  "contractId": "TODO_TOKENVEST_CONTRACT_ID"
};
