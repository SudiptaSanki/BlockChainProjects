          ...
          <button 
            ...
            className={`w-full py-3.5 rounded-xl font-bold text-xs tracking-widest uppercase transition-all duration-300 shadow-sm ${
              publicKey 
                ...
                : 'bg-amber-755 hover:bg-amber-900 text-white shadow-amber-850/15'
            }`}
          >
              ...
              >
                <div className="luxury-card p-8 rounded-3xl flex flex-col gap-6">
                  ...
                  <button 
                    ...
                    className="w-full py-4 rounded-xl bg-amber-700 hover:bg-amber-800 font-bold text-white shadow-md shadow-amber-805/10 transition-all duration-300"
                  >
