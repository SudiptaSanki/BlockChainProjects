      ...
      <aside className="w-72 bg-slate-900 border-r border-slate-800 p-6 flex flex-col justify-between shrink-0">
        <div className="flex flex-col gap-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-xl text-white">NexusSwap</h1>
        ...
        <div className="max-w-4xl mx-auto flex flex-col gap-8">
          ...
          {page === 'transfer' && (
            <div className="p-6 bg-slate-900 border border-slate-800 rounded-2xl flex flex-col gap-4">
              <h3 className="text-sm font-bold text-slate-300 uppercase tracking-wider">Execute Asset Swap</h3>
              <div>
              ...
              <button onClick={handleTransfer} disabled={txState === 'pending'} className="mt-2 py-3 rounded-xl text-white font-bold text-xs tracking-wide" style={{ backgroundColor: '#9333ea' }}>
          ...
          {page === 'contract' && (
            <div className="p-6 bg-slate-900 border border-slate-800 rounded-2xl flex flex-col gap-4">
              <h3 className="text-sm font-bold text-slate-300 uppercase tracking-wider">Token Swap Smart Contract</h3>
              ...
              <button onClick={callContract} disabled={txState === 'pending'} className="py-3 rounded-xl text-white font-bold text-xs" style={{ backgroundColor: '#9333ea' }}>
