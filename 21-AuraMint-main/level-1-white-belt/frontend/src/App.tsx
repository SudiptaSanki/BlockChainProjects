...
export default function App() {
  ...
  const [message, setMessage] = useState('AuraMint: Decentralized NFT Minter ready.');
      ...
      <div className="max-w-3xl w-full flex flex-col gap-8">
        ...
        <header className="flex flex-col sm:flex-row items-center justify-between gap-4 p-6 bg-slate-900/80 border border-slate-800 rounded-2xl backdrop-blur-md">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white tracking-wide">AuraMint: Decentralized NFT Minter</h1>
        ...
        <div className="p-6 bg-slate-900/60 border border-slate-800 rounded-2xl flex flex-col gap-6">
          <h2 className="text-lg font-bold text-white tracking-wide">Mint NFT Token</h2>
          ...
          <div className="flex flex-col gap-4">
            ...
            <button
              ...
              style={{ backgroundColor: '#059669' }}
            >
              {state === 'submitting' ? 'Signing & Submitting...' : 'Mint NFT Token'}
            </button>
          </div>
