...
const project = {
  ...
  "secondary": "#f43f5e",
  "accent": "#10b981",
  "contract": "Gift Card Vault Contract",
  "action": "Issue Gift Value",
  "contractId": "CC3RGIFT3RVAULT...TESTNET"
};
...
const pages = [
  ...
  { id: 'transfer', label: 'Issue Gift Card' },
    ...
    <div className="min-height-screen relative overflow-hidden bg-slate-950 text-slate-100 flex flex-col justify-between">
      ...
      <nav className="glass-panel sticky top-0 z-50 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <img src="/favicon.svg" alt="Gift3r Logo" className="w-10 h-10 object-contain drop-shadow-[0_0_8px_rgba(245,158,11,0.5)]" />
          <div>
            ...
            <span className="text-[10px] uppercase tracking-wider text-amber-400 font-semibold font-mono">Yellow Belt Control</span>
          </div>
        </div>
            ...
            >
              <div className="md:col-span-2 glass-panel p-8 rounded-3xl flex flex-col justify-center gap-6">
                ...
                <h2 className="text-3xl font-extrabold tracking-tight md:text-4xl bg-gradient-to-r from-white via-slate-200 to-slate-400 bg-clip-text text-transparent">
                  Issue Web3 Gift Card Vouchers
                </h2>
                <p className="text-slate-400 leading-relaxed text-sm">
                  The Yellow Belt control room interfaces directly with the deployed Soroban Smart Contract. Configure addresses, sync state logs, handle errors, and bridge MetaMask snap connections with Freighter.
                </p>
                <div className="flex gap-3">
                  <button 
                    onClick={() => setPage('wallets')}
                    className="px-5 py-3 rounded-xl bg-amber-600 text-slate-950 font-semibold shadow-lg shadow-amber-600/20 transition-all duration-300 text-sm"
                  >
                    Select Wallet
                  </button>
                  <button 
          ...
          {page === 'transfer' && (
            ...
            >
              <div className="glass-panel p-8 rounded-3xl flex flex-col gap-6 glow-accent">
                <h3 className="font-bold text-lg text-center">Issue Gift Card</h3>
                <p className="text-xs text-slate-400 text-center">Lock Stellar Testnet XLM into a gift card payout voucher.</p>

                <div className="flex flex-col gap-4">
                  <div className="flex flex-col gap-2">
                    <label className="text-xs uppercase tracking-wider text-slate-400 font-bold font-mono">Recipient Public Address</label>
                    <input 
                      value={destination} 
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-xs uppercase tracking-wider text-slate-400 font-bold font-mono">Gift Amount (XLM)</label>
                    <input 
                      type="number"
                      value={amount} 
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-xs uppercase tracking-wider text-slate-400 font-bold font-mono">Personalized Note</label>
                    <input 
                      value={memo} 
                ...
                <button 
                  ...
                  className="w-full py-4 rounded-2xl bg-gradient-to-r from-amber-500 to-rose-500 hover:opacity-95 font-bold text-white shadow-lg shadow-amber-500/20 transition-all duration-300"
                >
                  {txState === 'pending' ? 'Processing Voucher...' : 'Generate Gift Card'}
                </button>
