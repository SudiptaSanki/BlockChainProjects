...
const project = {
  ...
  "contractId": "CC3RMILESTONEVAULT...TESTNET"
};
...
const pages = [
  ...
  { id: 'transfer', label: 'Fund milestone' },
        ...
        return (
          ...
          >
            <div className="md:col-span-2 cyber-panel p-8 rounded flex flex-col justify-center gap-6">
              <span className="text-xs font-calligraphy text-orange-400">Ancient Trust in Digital Ledger Vaults</span>
            ...
            <div className="cyber-panel p-6 rounded flex flex-col justify-between gap-6">
              ...
              <div className="p-4 bg-black/50 rounded border border-orange-500/20 font-mono">
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-left font-mono">
                        ...
                        <span className={`text-xs ${selectedWallet === wallet.id ? 'text-orange-400' : 'text-stone-500'}`}>{wallet.note}</span>
                      </div>
                    </div>
                ...
                <div className="flex flex-col gap-2 mt-2 font-mono">
                  ...
                  {selectedWallet === 'freighter' ? (
                    <a 
                      ...
                      target="_blank" 
                      rel="noreferrer"
                      className="font-mono text-xs p-4 rounded bg-stone-950 border border-stone-850 text-orange-400 hover:text-orange-300 transition-all text-center block break-all"
                    >
                      {txHash}
                    </a>
                  ) : (
                    <div className="font-mono text-xs p-4 rounded bg-stone-950 border border-stone-850 text-orange-400 text-center block break-all">
    ...
    <div className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      <header className="w-full bg-black/90 px-8 py-4 flex justify-between items-center z-40 border-b border-orange-500/20">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-[9px] uppercase tracking-widest text-orange-400 font-bold block mt-1 font-mono">[ YELLOW_BELT_VAULT ]</span>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col justify-between z-35">
        <main className="max-w-4xl mx-auto w-full px-12 py-16 flex flex-col gap-10">
          ...
          {/* Status Display */}
          <div className="cyber-panel p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-l-4 border-l-orange-500">
