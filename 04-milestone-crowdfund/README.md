# 🚀 Milestone Crowdfund: Milestone-Based Escrow Crowdfunding

Milestone Crowdfund is a premium decentralized application (dApp) built on the Stellar network and Soroban smart contracts. It protects backers by locking crowdfunded capital in a secure, milestone-based escrow vault, releasing funds to creators only when specified project milestones are verified on-chain.

---

## 📁 Project Structure
The repository is organized into progressive levels:
- `level-1-white-belt/frontend/`: React + Vite frontend implementing wallet connection, balance retrieval, and basic escrow locking on-chain.
- `level-2-yellow-belt/`:
  - `contracts/`: Soroban Rust smart contracts managing milestone verification and escrow release logic.
...
![Level 1 Submission Screenshot](./screenshots/level1_milestone_crowdfund.png)
...
- **On-chain Sync:** Real-time event subscription log mirroring smart contract state, milestones, and escrow releases.
...
Transaction Hash: b621403030f14d72b35377db498c197f
